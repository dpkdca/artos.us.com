    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateInventory(newVariant) {
        if (!this.options['showInventoryQuantity']) {
         ...
         // Backup 19-02-25
        // var productFormInventory = this.element.querySelector('.ProductForm__Inventory span'),
        //     variantInventory = newVariant ? this.variantsInventories[newVariant['id']] : null;
       
        // if (!newVariant || null === variantInventory['inventory_management'] || variantInventory['inventory_quantity'] <= 0 || this.options['inventoryQuantityThreshold'] > 0 && variantInventory['inventory_quantity'] > this.options['inventoryQuantityThreshold']) {
        //   productFormInventory.classList.remove('lowstockinventory','instockinventory');
        //   productFormInventory.classList.add('outofstockinventory');
        //   productFormInventory.textContent = 'Out of Stock';
        //    console.log('Out of Stock');
        // } else if (!newVariant || null === variantInventory['inventory_management'] || variantInventory['inventory_quantity'] <= 10 || this.options['inventoryQuantityThreshold'] > 10 && variantInventory['inventory_quantity'] > this.options['inventoryQuantityThreshold']) {
        //   productFormInventory.classList.remove('outofstockinventory','instockinventory');
        //   productFormInventory.classList.add('lowstockinventory');
        //   productFormInventory.textContent = 'Low Stock';
        //    console.log('Low Stock');
        // } else {
        //   productFormInventory.classList.remove('outofstockinventory','lowstockinventory');
        //   productFormInventory.classList.add('instockinventory');
        ...
        var productFormInventory = this.element.querySelector('.ProductForm__Inventory span'),
            variantInventory = newVariant ? this.variantsInventories[newVariant['id']] : null;
            var callForEtaButton = this.element.querySelector('.ctabutton');
        ...
        if (!newVariant || null === variantInventory['inventory_management'] || variantInventory['inventory_quantity'] <= 0 || this.options['inventoryQuantityThreshold'] > 0 && variantInventory['inventory_quantity'] > this.options['inventoryQuantityThreshold']) {
          ...
          productFormInventory.textContent = 'Out of Stock';
           console.log('Out of Stock');
          if (callForEtaButton) callForEtaButton.style.display = 'inline-block';
        } else if (!newVariant || null === variantInventory['inventory_management'] || variantInventory['inventory_quantity'] <= 10 || this.options['inventoryQuantityThreshold'] > 10 && variantInventory['inventory_quantity'] > this.options['inventoryQuantityThreshold']) {
          productFormInventory.classList.remove('outofstockinventory','instockinventory');
          productFormInventory.classList.add('lowstockinventory');
          productFormInventory.textContent = 'Low Stock';
           console.log('Low Stock');
          if (callForEtaButton) callForEtaButton.style.display = 'none';
        } else {
          productFormInventory.classList.remove('outofstockinventory','lowstockinventory');
          productFormInventory.classList.add('instockinventory');
          productFormInventory.textContent = variantInventory['inventory_message'];
  ...
  var ProductSection = function () {
    ...
    _createClass(ProductSection, [{
      ...
      value: function _updateSlideshowImage(event) {
        ...
        //   var slick_index = $('.Carousel__Cell').attr('data-image-position');
